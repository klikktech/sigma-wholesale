...
public class SecurityConfig {
    ...
    private static final String[] WHITE_LIST_URL = new String[]{"/api/auth/**","/products/**","/categories/**","/brands/**", "/banners/**", "/users/**","/variations/**","/orders/**","/cart/**","/checkout/**","/payment/**","/search/**","/api/auth/logout"};
