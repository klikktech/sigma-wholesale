...
const ProductView = () => {
    ...
    const [quantities, setQuantities] = useState([
        ...
        { id: 2, image: "https://png.pngtree.com/thumb_back/fw800/background/20231002/pngtree-3d-render-vape-mod-surrounded-by-billowing-smoke-image_13568822.png", quantity: 0 },
        { id: 3, image: "https://png.pngtree.com/thumb_back/fw800/background/20231004/pngtree-smoke-surrounds-3d-render-of-a-vape-mod-image_13568824.png", quantity: 0 },
        { id: 4, image: "https://image.slidesdocs.com/responsive-images/background/3d-representation-of-a-vaping-icon-powerpoint-background_fecf4dc12b__960_540.jpg", quantity: 0 },
        { id: 5, image: "https://s3.amazonaws.com/brandrepup/page_images/61069/original/144010250_presentation-wide.jpg?1640967522", quantity: 0 },
    ...
    return <>
        <div className="flex gap-x-10">
            ...
            <div className="w-full md:w-1/2">
                ...
                <p className="text-large font-bold my-3">
                    Available Options
                </p>
                {quantities.map((item) => (
                    <div key={item.id}
