...
import { HOME_PAGE_ROUTE, LOGIN_PAGE_ROUTE, PRIVACY_POLICY_PAGE_ROUTE, PRODUCTS_PAGE_ROUTE, RETURN_POLICY_PAGE_ROUTE, SHIPPING_POLICY_PAGE_ROUTE, SIGNUP_PAGE_ROUTE, TERMS_AND_CONDITIONS_PAGE_ROUTE } from "@/utils/urls";
